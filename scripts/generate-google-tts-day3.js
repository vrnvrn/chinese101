#!/usr/bin/env node
/*
 * Regenerate June Day 3 Mandarin audio with Google Cloud Text-to-Speech.
 *
...
const OUT_DIR = path.join(ROOT, 'audio', 'june', 'day3');
const TMP_DIR = path.join(ROOT, 'audio', 'june', `.day3-google-tmp-${Date.now()}`);
